...
`;function A(){if(typeof document>"u"||document.getElementById("af-feeder-styles"))return;const a=document.createElement("style");a.id="af-feeder-styles",a.appendChild(document.createTextNode(v)),document.head.appendChild(a)}const s="automatic-feeder";function g(a){return((a==null?void 0:a.instance)!==void 0&&a.instance!==""?String(a.instance):"0").split(".").pop()||"0"}function C(a){const t=a==null?void 0:a.switchId;return t?`${s}.${g(a)}.switches.${t}`:""}async function k(a,t){var i;try{const o=await a.getObject(`system.adapter.${s}.${t}`);return(((i=o==null?void 0:o.native)==null?void 0:i.switches)||[]).filter(e=>e&&e.id).map((e,f)=>({id:String(e.id),name:e.name&&e.name.trim()||String(e.id)||`Switch ${f+1}`}))}catch{return[]}}function _(a){const{socket:t,data:i,onDataChange:o,label:c}=a,[e,f]=u([]),d=g(i);m(()=>{let n=!0;return k(t,d).then(x=>n&&f(x)),()=>{n=!1}},[t,d]);const p=i.switchId||"";return b(h,{fullWidth:!0,variant:"standard",size:"small",children:[r(w,{children:c}),r(y,{value:e.some(n=>n.id===p)?p:"",onChange:n=>o({...i,switchId:n.target.value}),children:e.length?e.map(n=>r(l,{value:n.id,children:n.name},n.id)):r(l,{value:"",disabled:!0,children:"—"})})]})}function $(){return{name:"common",fields:[{name:"instance",type:"instance",label:"feeder_instance",adapter:s,isShort:!0,default:"0"},{name:"switchId",type:"custom",label:"switch",component:(a,t,i,o)=>r(_,{socket:o.context.socket,data:t,onDataChange:i,label:a.label||"switch"})}]}}export{C as c,$ as f,A as i};
